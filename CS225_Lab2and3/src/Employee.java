 ...
 * Description: This file contains the source code for Lab 3, for the Employee class.
 */
...
public class Employee extends UniqueObject
{
	...
	public Employee (String fn, String ln, double hr, double y)
	{
		firstName = fn;
		lastName = ln;
		hourlyRate = hr;
	...
	// Values to get the salary per year
	protected double getsalPerYear()
	{
		double salPerWeek = hourlyRate * 40;
		double salPerYear = salPerWeek * 52;
		return salPerYear;
	}
	
	// Incrementing years and increasing hourlyRate by 3%
	public void promote(){
		years++ ;
		hourlyRate = hourlyRate + hourlyRate * .03;
	}
	
	public String toString(){
		String statement = firstName + " " + lastName + 
		" (#" + getUniqueIdString() + ")" + 
		" has been with the company for "+ mf.format(years) 
		+ " years and makes " + df.format(hourlyRate) + "/hr.";
		return statement;		
		}
}
