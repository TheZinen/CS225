 ...
 * File Name: CS225_Lab3_Client.java
 * Java Programming
 * Lab 3
 * Instructor: Dr. Dan Grissom
 * 
 * Description: This file contains the source code for the client for Lab 3.
...
public class CS225_Lab3_Client
{
	public static void main(String[] args)
	{
		...
		ArrayList<Employee> externalEmployeeList = new ArrayList<Employee>();
		
		
		// Create manager
		Manager m = new Manager("Matson", "Jer", 20.0, 5);
		...
		for (Employee e : externalEmployeeList)
