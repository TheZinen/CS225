 ...
 * Description: This file contains the source code for Lab 3, for the UniqueObject class.
 */
...
public class UniqueObject
{
	...
	// Converts the ID into 4-digit String
	protected String getUniqueIdString(){
		String uniqueId = df.format(getUniqueId());
		return uniqueId;
	}
}