...
public class PersonalizedFbBanner extends FbBanner implements RandomDrawMethods
{
	...
	public void DrawRandomFilledOval() 
	{
		...
		g2d.setColor(bannerColors[6]); 
		g2d.fillOval(x, y, r.nextInt(150), r.nextInt(150));
	}
	public void DrawRandomFilledRectangle() 
	{
		int x = r.nextInt(this.getWidth());
		int y = r.nextInt(this.getHeight());
		g2d.setColor(bannerColors[4]); 
		g2d.fillRect(x, y, r.nextInt(100), r.nextInt(100));
	}
	public void DrawTextAtRandomLocation(String txt) {
		int x = r.nextInt(this.getWidth());
		int y = r.nextInt(this.getHeight());
		g2d.setColor(Color.BLACK); 
		g2d.drawString("Oh snap, that's sick!", x, y);
	}
	public void DrawCustomizedDecoration() {
		g2d.setColor(Color.CYAN);
		g2d.fillRect(0, 0, 1000, 100);
		g2d.setColor(Color.DARK_GRAY);
		g2d.fillRect(0, 75, 1000, 100);
		g2d.setColor(Color.MAGENTA);
		g2d.fillRect(0, 150, 1000, 100);
		g2d.setColor(Color.LIGHT_GRAY);
		g2d.fillRect(0, 225, 1000, 100);
		g2d.setColor(Color.BLACK);
		int x = r.nextInt(this.getWidth());
		int y = r.nextInt(this.getHeight());
		g2d.setColor(Color.BLACK); 
