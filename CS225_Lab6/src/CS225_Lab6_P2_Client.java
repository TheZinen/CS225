 ...
 * File Name: CS225_Lab6_P2_Client.java
 * Java Programming
 * Lab 6 - Due X/XX/XXXX
 ...
 * Description: This file contains the source code for Lab 6, Problem 2.
 */
...
///////////////////////////////////////////////////////////////////////////////
public class CS225_Lab6_P2_Client
{
	public static void main(String[] args)
	{
		...
		do 
		{
			System.out.println("Please enter your 1st password: ");
			p1 = scan.next();
			System.out.println("Please enter your 2nd password: ");
			p2 = scan.next();
			try
			{
				password = new Password(p1, p2);
				isValid = true;
			}
		...
		System.out.println("Password is valid! Your password is: " + password.getPassword());
	}
}
